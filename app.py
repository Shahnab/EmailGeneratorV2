...
st.sidebar.image("https://www.freeiconspng.com/thumbs/email-icon/email-icon--clipart-best-22.png", width=100)
...
st.components.v1.iframe("https://shad0ws-emailgenerator-usecase.hf.space", width=1500, height=550, scrolling=True)
